...
public class MainImageDataPartChar
{
    ...
    public MainImageDataPartChar(sbyte[] issImg, sbyte[] iss, sbyte type, short id, short version)
    {
        ...
        //    {
        //            "G://KnightAge//resource//data//x", mGraphics.zoomLevel ,"//part//Img//", type + "_" +  this.GetPathName(type) + "//", type + "_" + id, ".png"
        ...
        //if (iss != null)
        //{
        //    String filePath = "G://KnightAge//resource//data//x" + mGraphics.zoomLevel + "//part//Data//" + type + "_" + this.GetPathName(type) + "//" + type + "_" + id;
