...
public class Player : MainObject
{
    ...
    public static void setXFocus(int x)
    {
        StackTrace stackTrace = new StackTrace();
        StackFrame callerFrame = stackTrace.GetFrame(1);
        MethodBase callerMethod = callerFrame.GetMethod();
        //UnityEngine.Debug.LogError("Set x phuong thuc : " + callerMethod.DeclaringType.FullName + "." + callerMethod.Name);

        xFocus = x;
    }

    public static void setYFocus(int y)
    {
        StackTrace stackTrace = new StackTrace();
        StackFrame callerFrame = stackTrace.GetFrame(1);
        MethodBase callerMethod = callerFrame.GetMethod();

        //UnityEngine.Debug.LogError("Set y phuong thuc : " + callerMethod.DeclaringType.FullName + "." + callerMethod.Name);
        yFocus = y;
    }
