...
public class MainItemMap
{
    ...
    public MainItemMap(short IDItem, short IDImage, int dx, int dy, int[][] Block)
    {
        ...
        string filePath = $"G://table_map.sql";
        string sql = $"INSERT INTO table_map (IDItem, IDImage, dx, dy, Block) VALUES ({IDItem}, {IDImage}, {dx}, {dy}, '{JsonConvert.SerializeObject((object)Block)}');";
