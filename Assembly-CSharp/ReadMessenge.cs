...
public class ReadMessenge : AvMain
{
    ...
    public void changeMap(Message msg)
    {
        ...
        try
        {
            //string logPath = "G:\\message_log";
            //if (msg.writer().getData() != null)
            //{
            //    sbyte[] writerData = msg.writer().getData();
            //    File.WriteAllBytes(logPath, Array.ConvertAll<sbyte, byte>(writerData, (sbyte a) => (byte)a));
